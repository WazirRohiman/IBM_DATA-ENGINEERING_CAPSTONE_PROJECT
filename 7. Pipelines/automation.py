...
def get_latest_records(last_row_id):
    ...
    cursor.execute(SQL,(last_row_id))
...
'''
if you get any reason code 7 error in the terminal, run the below command in Db2 and then rerun the file
